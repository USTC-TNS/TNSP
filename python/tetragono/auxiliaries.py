...
class Auxiliaries:
    __slots__ = [
        "L1", "L2", "cut_dimension", "normalize", "Tensor", "_one", "_one_l1", "_one_l2", "_lattice", "_zip_row", "_up_to_down", "_up_to_down_site", "_down_to_up", "_down_to_up_site", "_zip_column",
        "_left_to_right", "_left_to_right_site", "_right_to_left", "_right_to_left_site", "_inline_left_to_right", "_inline_left_to_right_tailed", "_inline_right_to_left",
    ...
    def _construct_inline_left_to_right(self, l1: int, l2: int) -> lazy.Node[self.Tensor]:
        if l2 == -1:
            ...
            return lazy.Node(self._construct_inline_left_to_right_in_lazy, self._inline_left_to_right_tailed[l1, l2 - 1], self._lattice[l1][l2], self._down_to_up_site[l1 + 1, l2], self.normalize, l1,
                             l2)

    @staticmethod
    def _construct_inline_left_to_right_in_lazy(inline_left_to_right_tailed: self.Tensor, lattice: self.Tensor, down_to_up: self.Tensor, normalize: bool, l1: int, l2: int) -> self.Tensor:
    ...
    def _construct_inline_right_to_left(self, l1: int, l2: int) -> lazy.Node[self.Tensor]:
        if l2 == self.L2:
            ...
            return lazy.Node(self._construct_inline_right_to_left_in_lazy, self._inline_right_to_left_tailed[l1, l2 + 1], self._lattice[l1][l2], self._up_to_down_site[l1 - 1, l2], self.normalize, l1,
                             l2)

    @staticmethod
    def _construct_inline_right_to_left_in_lazy(inline_right_to_left_tailed: self.Tensor, lattice: self.Tensor, up_to_down: self.Tensor, normalize: bool, l1: int, l2: int) -> self.Tensor:
    ...
    def _construct_inline_up_to_down(self, l1: int, l2: int) -> lazy.Node[self.Tensor]:
        if l1 == -1:
            ...
            return lazy.Node(self._construct_inline_up_to_down_in_lazy, self._inline_up_to_down_tailed[l1 - 1, l2], self._lattice[l1][l2], self._right_to_left_site[l1, l2 + 1], self.normalize, l1, l2)

    @staticmethod
    def _construct_inline_up_to_down_in_lazy(inline_up_to_down_tailed: self.Tensor, lattice: self.Tensor, right_to_left: self.Tensor, normalize: bool, l1: int, l2: int) -> self.Tensor:
    ...
    def _construct_inline_down_to_up(self, l1: int, l2: int) -> lazy.Node[self.Tensor]:
        if l1 == self.L1:
            ...
            return lazy.Node(self._construct_inline_down_to_up_in_lazy, self._inline_down_to_up_tailed[l1 + 1, l2], self._lattice[l1][l2], self._left_to_right_site[l1, l2 - 1], self.normalize, l1, l2)

    @staticmethod
    def _construct_inline_down_to_up_in_lazy(inline_down_to_up_tailed: self.Tensor, lattice: self.Tensor, left_to_right: self.Tensor, normalize: bool, l1: int, l2: int) -> self.Tensor:
    ...
    @staticmethod
    def _two_line_to_one_line(udlr_name: list[str], line_1: list[self.Tensor], line_2: list[self.Tensor], cut: int, normalize: bool) -> list[self.Tensor]:
        ...
        for i in range(length):
            double_line.append(safe_contract(line_1[i].edge_rename({left: left1, right: right1}), line_2[i].edge_rename({left: left2, right: right2}), {(down, up)}))
