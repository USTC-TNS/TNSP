...
namespace TAT {
   ...
   [[nodiscard]] Tensor<ScalarType, Symmetry, Name> singular_to_tensor(const std::map<Symmetry, vector<real_base_t<ScalarType>>>& singular) {
      ...
      auto result = Tensor<ScalarType, Symmetry, Name>({NameTraits<Name>::SVD_U, NameTraits<Name>::SVD_V}, std::move(symmetries));
   ...
   Tensor<ScalarType, Symmetry, Name>::svd(const std::set<Name>& free_name_set_u, const Name& common_name_u, const Name& common_name_v, Size cut)
      ...
      auto tensor_merged = edge_operator(
            ...
            {},
            reversed_set_origin,
            {{NameTraits<Name>::SVD_U, free_name_u}, {NameTraits<Name>::SVD_V, free_name_v}},
            put_v_right ? std::vector<Name>{NameTraits<Name>::SVD_U, NameTraits<Name>::SVD_V} :
                          std::vector<Name>{NameTraits<Name>::SVD_V, NameTraits<Name>::SVD_U});
      ...
      auto u = tensor_u.template edge_operator<true>(
            {{NameTraits<Name>::SVD_V, common_name_u}},
            {{NameTraits<Name>::SVD_U, free_names_and_edges_u}},
            reversed_set_u,
            {},
            result_name_u,
            false,
            {{{}, put_v_right ? std::set<Name>{} : std::set<Name>{common_name_u}, {}, {}}},
            {{NameTraits<Name>::SVD_V, remain_dimension_u}});
      auto v = tensor_v.template edge_operator<true>(
            {{NameTraits<Name>::SVD_U, common_name_v}},
            {{NameTraits<Name>::SVD_V, free_names_and_edges_v}},
            reversed_set_v,
            {},
            result_name_v,
            false,
            {{{}, {}, {}, {}}},
            {{NameTraits<Name>::SVD_U, remain_dimension_v}});
      return {
            std::move(u),
