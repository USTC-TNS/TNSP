...
namespace TAT {
   ...
   typename Tensor<ScalarType, Symmetry, Name>::qr_result Tensor<ScalarType, Symmetry, Name>::qr(
      ...
      auto tensor_merged = edge_operator(
            ...
            {},
            reversed_set_origin,
            {{NameTraits<Name>::QR_1, free_name_1}, {NameTraits<Name>::QR_2, free_name_2}},
            {NameTraits<Name>::QR_1, NameTraits<Name>::QR_2});
      // call lapack
      ...
      auto tensor_1 = Tensor<ScalarType, Symmetry, Name>{
            {NameTraits<Name>::QR_1, NameTraits<Name>::QR_2}, {std::move(tensor_merged.core->edges[0]), std::move(common_edge_1)}};
      auto tensor_2 = Tensor<ScalarType, Symmetry, Name>{
            {NameTraits<Name>::QR_1, NameTraits<Name>::QR_2}, {std::move(common_edge_2), std::move(tensor_merged.core->edges[1])}};
      ...
      auto new_tensor_1 = tensor_1.template edge_operator<true>(
            {{NameTraits<Name>::QR_2, use_qr_not_lq ? common_name_q : common_name_r}},
            {{NameTraits<Name>::QR_1, free_names_and_edges_1}},
            reversed_set_1,
            {},
            result_name_1);
      auto new_tensor_2 = tensor_2.template edge_operator<true>(
            {{NameTraits<Name>::QR_1, use_qr_not_lq ? common_name_r : common_name_q}},
            {{NameTraits<Name>::QR_2, free_names_and_edges_2}},
            reversed_set_2,
            {},
            result_name_2,
            false,
