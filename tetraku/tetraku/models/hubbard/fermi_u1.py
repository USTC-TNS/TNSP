...
def abstract_state(L1, L2, T, t, U):
    ...
    state.total_symmetry = (T, 0)
    state.physics_edges[...] = [((0, 0), 1), ((1, 1), 1), ((1, -1), 1), ((2, 0), 1)]
    NN = tet.common_tensor.FermiU1_Hubbard.NN.to(float)
    CSCS = tet.common_tensor.FermiU1_Hubbard.CSCS.to(float)
