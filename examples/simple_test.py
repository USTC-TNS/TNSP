...
def test_create_tensor():
    ...
    print(TAT.Tensor.DNo([], []).set(lambda: 10)[{}])
    print(TAT.Tensor.ZNo(["Left", "Right"], [
          3, 4]).test()[{"Right": 2, "Left": 1}])


def test_create_symmetry_tensor():
    print(TAT.Tensor.DZ2(["Left", "Right", "Up"], [
          {1: 3, 0: 1}, {1: 1, 0: 2}, {1: 2, 0: 3}]).zero())
    print(TAT.Tensor.DU1(["Left", "Right", "Up"], [
          {-1: 3, 0: 1, 1: 2}, {-1: 1, 0: 2, 1: 3}, {-1: 2, 0: 3, 1: 1}]).test(2))
    print(TAT.Tensor.DU1(["Left", "Right", "Up"], [
          {}, {-1: 1, 0: 2, 1: 3}, {-1: 2, 0: 3, 1: 1}]).zero())
    print(TAT.Tensor.DU1([], []).set(lambda: 123))


def test_create_fermi_symmetry_tensor():
    print(TAT.Tensor.DFermi(["Left", "Right", "Up"], [
          {0: 1, 1: 2}, {-1: 1, -2: 3, 0: 2}, {0: 3, 1: 1}], True).test(2))
    print(TAT.Tensor.DFermiU1(["Left", "Right", "Up"], [{(0, 0): 1, (1, 1): 2}, {
          (-1, -1): 1, (-2, 0): 3, (0, 0): 2}, {(0, 0): 3, (1, -1): 1}], True).test(2))
    print(TAT.Tensor.DFermiU1(["Left", "Right", "Up"], [{(0, 0): 1, (1, 1): 2}, {(-1, -1): 1, (-2, 0): 3, (0, 0): 2}, {
          (0, 0): 3, (1, -1): 1}], True).test(2).block({"Left": (1, 1), "Up": (1, -1), "Right": (-2, 0)}))
    print(TAT.Tensor.DFermiU1(1234)[{}])
    print(TAT.Tensor.DFermiU1(["Left", "Right", "Up"], [{(0, 0): 1, (1, 1): 2}, {(-1, -1): 1, (-2, 0): 3, (0, 0): 2}, {
          (0, 0): 3, (1, -1): 1}], True).test(2)[{"Left": ((1, 1), 1), "Up": ((1, -1), 0), "Right": ((-2, 0), 0)}])
...
def test_type_conversion():
    ...
    print(TAT.Tensor.DNo(["Left", "Right"], [
          3, 4]).test(2).to_double_complex())
    print(TAT.Tensor.ZNo(["Left", "Right"], [3, 4]).test(2).to_double_real())
    print(TAT.Tensor.DU1(["Left", "Right", "Up"], [
          {-1: 3, 0: 1, 1: 2}, {-1: 1, 0: 2, 1: 3}, {-1: 2, 0: 3, 1: 1}]).test(2).to_double_complex())


def test_norm():
    t = TAT.Tensor.DU1("Left Right Up".split(" "), [
                       {-1: 3, 0: 1, 1: 2}, {-1: 1, 0: 2, 1: 3}, {-1: 2, 0: 3, 1: 1}]).test(2).to_double_complex()
    print(t.norm_max())
    print(t.norm_num())
    print(t.norm_1())
...
def test_scalar():
    t = TAT.Tensor.DZ2(["Left", "Right", "Phy"], [
...
def test_edge_rename():
    t1 = TAT.Tensor.DZ2(["Left", "Right", "Phy"], [
...
def test_transpose():
    ...
    c = TAT.Tensor.ZU1(["Left", "Right", "Up"], [
                       {-1: 3, 0: 1, 1: 2}, {-1: 1, 0: 2, 1: 3}, {-1: 2, 0: 3, 1: 1}]).test(1)
    print(c)
    ...
    d = TAT.Tensor.DFermi(["Left", "Right", "Up"], [
                          {-1: 3, 0: 1, 1: 2}, {-1: 1, 0: 2, 1: 3}, {-1: 2, 0: 3, 1: 1}], True) .test(1)
    print(d)
...
def test_split_and_merge():
    ...
    e = TAT.Tensor.ZFermi(["Left", "Right", "Up"], [
                          {-1: 3, 0: 1, 1: 2}, {-1: 1, 0: 2, 1: 3}, {-1: 2, 0: 3, 1: 1}]).set(initializer(0))
    print(e)
...
def test_edge_operator():
    ...
    print(TAT.Tensor.DNo(["A", "B"], [8, 8]).test().edge_operator({"A": "C"}, {"C": [("D", 4), ("E", 2)], "B": [
          ("F", 2), ("G", 4)]}, {"D", "F"}, {"I": ["D", "F"], "J": ["G", "E"]}, ["J", "I"]))
    print(TAT.Tensor.DNo(["A", "B", "C"], [2, 3, 4]).test(
    ).edge_operator({}, {}, set(), {}, ["B", "C", "A"]))

    a = TAT.Tensor.DU1(["Left", "Right", "Up", "Down"], [
                       {-1: 3, 0: 1, 1: 2}, {-1: 1, 0: 4, 1: 2}, {-1: 2, 0: 3, 1: 1}, {-1: 1, 0: 3, 1: 2}]).test(1)
    b = a.edge_rename({"Right": "Right1"}).split_edge(
        {"Down": [("Down1", {0: 1, 1: 2}), ("Down2", {-1: 1, 0: 1})]})
    c = b.transpose(["Down1", "Right1", "Up", "Left", "Down2"])
    d = c.merge_edge({"Left": ["Left", "Down2"]})
    total = a.edge_operator({"Right": "Right1"}, {"Down": [("Down1", {0: 1, 1: 2}), ("Down2", {
                            -1: 1, 0: 1})]}, set(), {"Left": ["Left", "Down2"]}, ["Down1", "Right1", "Up", "Left"])
    print((total - d).norm_max())

    a = TAT.Tensor.DFermi(["Left", "Right", "Up", "Down"], [
                          {-1: 3, 0: 1, 1: 2}, {-1: 1, 0: 4, 1: 2}, {-1: 2, 0: 3, 1: 1}, {-1: 1, 0: 3, 1: 2}]).test(1)
    b = a.edge_rename({"Right": "Right1"}).split_edge(
        {"Down": [("Down1", {0: 1, 1: 2}), ("Down2", {-1: 1, 0: 1})]})
    ...
    d = c.merge_edge({"Left": ["Left", "Down2"]})
    total = a.edge_operator({"Right": "Right1"}, {"Down": [("Down1", {0: 1, 1: 2}), ("Down2", {
                            -1: 1, 0: 1})]}, {"Left"}, {"Left": ["Left", "Down2"]}, ["Down1", "Right1", "Up", "Left"])
    print((total - d).norm_max())
    print(total)
...
def test_contract():
    ...
    print(TAT.Tensor.DNo(["A", "B", "C", "D"], [1, 2, 3, 4]).test().contract(
        TAT.Tensor.DNo(["E", "F", "G", "H"], [3, 1, 2, 4]).test(), {("B", "G"), ("D", "H")}))

    c = TAT.Tensor.DFermi(["A", "B", "C", "D"], [
                          {-1: 1, 0: 1, -2: 1}, {0: 1, 1: 2}, {0: 2, 1: 2}, {-2: 2, -1: 1, 0: 2}], True).test()
    d = TAT.Tensor.DFermi(["E", "F", "G", "H"], [
                          {0: 2, 1: 1}, {-2: 1, -1: 1, 0: 2}, {0: 1, -1: 2}, {0: 2, 1: 1, 2: 2}], True).test()
    print(c)
    print(d)
    print(c.contract(d, {("B", "G"), ("D", "H")}))
    print(c.transpose(["A", "C", "B", "D"]).contract(
        d.transpose(["G", "H", "E", "F"]), {("B", "G"), ("D", "H")}))
...
def test_svd():
    ...
    print(v)
    print(s)
    print(v.multiple(s, "F", 'u').contract(
    ...
    print(v)
    print(s)
    print(v.multiple(s, "F", 'u').contract(u, {("F", "E")}).transpose(
    ...
    print(v.copy().multiple(s, "F", 'v').contract(u, {("F", "E")}).transpose(
        ["A", "B", "C", "D"]).transform(lambda x: 0 if abs(x) < 0.01 else x))
    print(v.contract(u.copy().multiple(s, "E", 'u'), {("F", "E")}).transpose(
        ["A", "B", "C", "D"]).transform(lambda x: 0 if abs(x) < 0.01 else x))
