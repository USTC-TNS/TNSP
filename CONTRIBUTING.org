...
- [[/include/TAT/structure/symmetry.hpp][=symmetry.hpp=]] outlines the generic symmetry type =Symmetry=. This can be instantiated as various symmetries such as =NoSymmetry=, =BoseU1Symmetry=, =BoseZ2Symmetry=, =FermiZ2Symmetry=, =FermiU1Symmetry=, among others.
