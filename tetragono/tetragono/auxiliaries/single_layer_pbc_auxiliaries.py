...
import lazy
from ..common_toolkit import safe_contract, safe_rename, safe_trace
...
class SingleLayerAuxiliaries:
    ...
    def _construct_inline_left_to_right_in_lazy(inline_left_to_right_tailed, lattice, down_to_up, normalize, l1, l2):
        ...
        result = safe_contract(inline_left_to_right_tailed, safe_rename(lattice, {
            "R": "R2",
            "L": "L2"
        }), {("R2", "L2"), ("D", "U")})
        result = safe_contract(result, safe_rename(down_to_up, {
            "R": "R3",
            "L": "L3"
        }), {("R3", "L3"), ("D", "U"), ("U", "D")})
        result = safe_trace(result, {("U", "D")})
        if normalize:
    ...
    def _construct_inline_left_to_right_tailed_in_lazy(inline_left_to_right, up_to_down, l1, l2):
        ...
        return safe_contract(inline_left_to_right, safe_rename(up_to_down, {"R": "R1", "L": "L1"}), {("R1", "L1")})
    ...
    def _construct_inline_right_to_left_in_lazy(inline_right_to_left_tailed, lattice, up_to_down, normalize, l1, l2):
        ...
        result = safe_contract(inline_right_to_left_tailed, safe_rename(lattice, {
            "L": "L2",
            "R": "R2"
        }), {("L2", "R2"), ("U", "D")})
        result = safe_contract(result, safe_rename(up_to_down, {
            "L": "L1",
            "R": "R1"
        }), {("L1", "R1"), ("U", "D"), ("D", "U")})
        result = safe_trace(result, {("D", "U")})
        if normalize:
            result /= result.norm_2()
        return result
    ...
    def _construct_inline_right_to_left_tailed_in_lazy(inline_right_to_left, down_to_up, l1, l2):
        ...
        return safe_contract(inline_right_to_left, safe_rename(down_to_up, {"L": "L3", "R": "R3"}), {("L3", "R3")})
    ...
    def _construct_inline_up_to_down_in_lazy(inline_up_to_down_tailed, lattice, right_to_left, normalize, l1, l2):
        ...
        result = safe_contract(inline_up_to_down_tailed, safe_rename(lattice, {
            "D": "D2",
            "U": "U2"
        }), {("D2", "U2"), ("R", "L")})
        result = safe_contract(result, safe_rename(right_to_left, {
            "D": "D3",
            "U": "U3"
        }), {("D3", "U3"), ("R", "L"), ("L", "R")})
        result = safe_trace(result, {("L", "R")})
        if normalize:
            result /= result.norm_2()
        return result
    ...
    def _construct_inline_up_to_down_tailed_in_lazy(inline_up_to_down, left_to_right, l1, l2):
        ...
        return safe_contract(inline_up_to_down, safe_rename(left_to_right, {"D": "D1", "U": 'U1'}), {("D1", "U1")})
    ...
    def _construct_inline_down_to_up_in_lazy(inline_down_to_up_tailed, lattice, left_to_right, normalize, l1, l2):
        ...
        result = safe_contract(inline_down_to_up_tailed, safe_rename(lattice, {
            "U": "U2",
            "D": "D2"
        }), {("U2", "D2"), ("L", "R")})
        result = safe_contract(result, safe_rename(left_to_right, {
            "U": "U1",
            "D": "D1"
        }), {("U1", "D1"), ("L", "R"), ("R", "L")})
        result = safe_trace(result, {("R", "L")})
        if normalize:
            result /= result.norm_2()
        return result
    ...
    def _construct_inline_down_to_up_tailed_in_lazy(inline_down_to_up, right_to_left, l1, l2):
        ...
        return safe_contract(inline_down_to_up, safe_rename(right_to_left, {"U": "U3", "D": "D3"}), {("U3", "D3")})
    ...
    def _construct_4_inline_left_to_right_in_lazy(inline_left_to_right_tailed, lattice_2, lattice_3, down_to_up,
                                                  normalize, l1, l2):
        result = safe_contract(inline_left_to_right_tailed, safe_rename(lattice_2, {
            "R": "R2",
            "L": "L2"
        }), {("R2", "L2"), ("D", "U")})
        result = safe_contract(result, safe_rename(lattice_3, {"R": "R3", "L": "L3"}), {("R3", "L3"), ("D", "U")})
        result = safe_contract(result, safe_rename(down_to_up, {
            "R": "R4",
            "L": "L4"
        }), {("R4", "L4"), ("D", "U"), ("U", "D")})
    ...
    def _construct_4_inline_right_to_left_in_lazy(inline_right_to_left_tailed, lattice_3, lattice_2, up_to_down,
                                                  normalize, l1, l2):
        result = safe_contract(inline_right_to_left_tailed, safe_rename(lattice_3, {
            "L": "L3",
            "R": "R3"
        }), {("L3", "R3"), ("U", "D")})
        result = safe_contract(result, safe_rename(lattice_2, {"L": "L2", "R": "R2"}), {("L2", "R2"), ("U", "D")})
        result = safe_contract(result, safe_rename(up_to_down, {
            "L": "L1",
            "R": "R1"
        }), {("L1", "R1"), ("U", "D"), ("D", "U")})
    ...
    def _construct_4_inline_right_to_left_tailed_in_lazy(inline_right_to_left, down_to_up, l1, l2):
        return safe_contract(inline_right_to_left, safe_rename(down_to_up, {"L": "L4", "R": "R4"}), {("L4", "R4")})
    ...
    def _two_line_to_one_line(udlr_name, line_1, line_2, cut, normalize):
        ...
        # Most of internal edge will be "merged" automatically by qr, but the edge at boundary does not.
        merge_left = []
        if left1 in double_line[0].names:
            merge_left.append(left1)
        if left2 in double_line[0].names:
            merge_left.append(left2)
        double_line[0] = double_line[0].merge_edge({left: merge_left})
        merge_right = []
        if right1 in double_line[length - 1].names:
            merge_right.append(right1)
        if right2 in double_line[length - 1].names:
            merge_right.append(right2)
        double_line[length - 1] = double_line[length - 1].merge_edge({right: merge_right})
        # TODO need to canonicalize the loop more, one time qr is not enough
        # TODO besides here, before construct aux, the canonicalization between line need consider too
    ...
    def hole(self, position, *, hint=None):
        if len(position) == 0:
            ...
            direction, line = hint
            if direction == "H":
                return safe_trace(self._inline_right_to_left[line, 0](), {("L1", "R1"), ("L2", "R2"), ("L3", "R3")})
            elif direction == "V":
                return safe_trace(self._inline_down_to_up[0, line](), {("U1", "D1"), ("U2", "D2"), ("U3", "D3")})
            else:
                raise ValueError("Unrecognized hint")
        elif len(position) == 1:
            l1, l2 = position[0]
