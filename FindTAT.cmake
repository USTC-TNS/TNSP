...
if(TAT_BUILD_PYTAT)
   ...
   file(GLOB PYTAT_LIGHT_SRC ${PROJECT_SOURCE_DIR}/PyTAT/.*No.cpp)
   pybind11_add_module(PyTAT ${PYTAT_SRC} ${PROJECT_SOURCE_DIR}/PyTAT/PyTAT.cpp EXCLUDE_FROM_ALL)
   pybind11_add_module(PyTATLight ${PYTAT_LIGHT_SRC} ${PROJECT_SOURCE_DIR}/PyTAT/PyTATLight.cpp EXCLUDE_FROM_ALL)
   ...
   target_link_libraries(PyTATLight PRIVATE TAT)
   set_target_properties(PyTATLight PROPERTIES OUTPUT_NAME No${TAT_PYTHON_MODULE})
   target_compile_definitions(PyTATLight PRIVATE TAT_PYTHON_MODULE=No${TAT_PYTHON_MODULE})
endif()
